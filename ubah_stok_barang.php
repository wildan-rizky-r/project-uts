...
<body>
	...
	<div class="tambah">
	<form action="proses_ubah_stok_barang.php" method="post">
		<input type="hidden" name="id_barang" value="<?=$dt_barang['id_barang']?>"><br>
		Kode Barang :
		<?=$dt_barang['kode_barang']?><br>
		Nama Barang :
		<?=$dt_barang['nama_barang']?><br>
		Stok Barang : 
		<input type="text" name="stok_barang" value="<?=$dt_barang['stok_barang']?>" class="it"><br>
		<input type="submit" name="simpan" value="Ubah Stok" class="simpan">
	</form>
	</div>
</body>
</html>